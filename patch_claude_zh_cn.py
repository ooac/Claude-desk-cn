...
def patch_hardcoded_frontend_strings(app: Path) -> None:
    ...
    replacements = {
        ...
        'hint:"Go straight to this provider at launch — users won\\\'t see the option to sign in to Anthropic instead."': 'hint:"启动时直接进入此提供商，用户不会看到改为登录 Anthropic 的选项。"',
        ...
        'description:"Extra HTTP headers sent on every inference request. JSON array of \'Name: Value\' strings."': 'description:"每次推理请求都会发送的额外 HTTP 请求头。格式为 Name: Value 字符串的 JSON 数组。"',
        ...
        'hint:"Stop Cowork from fetching updates. You\'ll need to push new versions yourself."': 'hint:"阻止 Cowork 获取更新。你需要自行推送新版本。"',
        'hint:"Hours before a downloaded update force-installs. Blank = 72-hour default."': 'hint:"已下载更新在多少小时后强制安装。留空则默认 72 小时。"',
        'hint:"Where Cowork sends OpenTelemetry logs and metrics. Leave blank to disable."': 'hint:"Cowork 发送 OpenTelemetry 日志和指标的位置。留空表示禁用。"',
        ...
        'hint:"Per-user soft cap, counted client-side over the duration below. Not a server-enforced quota."': 'hint:"按用户设置的软限制，在下方时长内由客户端统计。不是服务器强制配额。"',
